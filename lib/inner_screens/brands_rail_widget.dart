...
class BrandsNavigationRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //STEP5-Import the Product attributes here and use it to display the product details like imageUrl, title , price etc.
    final productsAttributes = Provider.of<Product>(context);
    return InkWell(
      //STEP6-SET THE ROUTE For product Detail
